...
class AlphaGeometryTest(unittest.TestCase):
    def test_translate_constrained_to_constructive(self):
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "T", list("addb")),
            ("on_dia", ["d", "b", "a"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "T", list("adbc")),
            ("on_tline", ["d", "a", "b", "c"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "P", list("bcda")),
            ("on_pline", ["d", "a", "b", "c"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "D", list("bdcd")),
            ("on_bline", ["d", "c", "b"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "D", list("bdcb")),
            ("on_circle", ["d", "b", "c"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "D", list("bacd")),
            ("eqdistance", ["d", "c", "b", "a"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "C", list("bad")),
            ("on_line", ["d", "b", "a"]),
        )
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "C", list("bad")),
        ...
        self.assertEqual(
            alphageometry.translate_constrained_to_constructive("d", "O", list("abcd")),
            ("on_circum", ["d", "a", "b", "c"]),
        )
