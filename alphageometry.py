...
_OUT_FILE = flags.DEFINE_string("out_file", "", "path to the solution output file.")  # pylint: disable=line-too-long
_BEAM_SIZE = flags.DEFINE_integer("beam_size", 1, "beam size of the proof search.")  # pylint: disable=line-too-long
