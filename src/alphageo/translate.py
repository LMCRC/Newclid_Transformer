...
def try_translate_constrained_to_construct(s: str, existing_points: Collection[str]) -> str:
    ...
    for prem in prems:
        ...
        except ValueError or IllegalPredicate:
...
def setup_str_from_problem(problem : Problem, definitions: dict[str, Definition]) -> str:
